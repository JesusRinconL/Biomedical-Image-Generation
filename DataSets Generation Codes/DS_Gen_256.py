...
if __name__ == '__main__':
    ...
    image_LABELdirectory = os.path.join(main_dir, "datasets_patrones\\DS1__6capas")
    dataset_path = os.path.join(main_dir,"DataSet_6capas_256")
    path_test = os.path.join(dataset_path,"test")
    path_train = os.path.join(dataset_path,"train")
    path_val = os.path.join(dataset_path,"val")


    used_images_file = os.path.join(os.path.dirname(main_dir), "used_images7.plk")
